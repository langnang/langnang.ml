        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
            <div class="flex items-center">
              <img src="/vendor/swagger-api/swagger-ui/dist/favicon-32x32.png" width="32">
              <div class="ml-4 text-lg leading-7 font-semibold">
                <a href="/api/documentation" class="underline text-gray-900 dark:text-white">L5 Swagger UI</a>
              </div>
            </div>

            <div class="ml-12">
              <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                Simplify API development for users, teams, and enterprises with the Swagger open source and professional
                toolset. Find out how Swagger can help you design and document your APIs at scale.
              </div>
            </div>
          </div>
          <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
            <div class="flex items-center">
              <img src="/public/vendors/dcat-admin/images/logo.png" width="32">
              <div class="ml-4 text-lg leading-7 font-semibold">
                <a href="/admin" class="underline text-gray-900 dark:text-white">Dcat Admin</a>
              </div>
            </div>
          ...
          <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
            <div class="flex items-center">
              <img src="{{ asset('webstack/favicon.ico') }}" width="32">
              <div class="ml-4 text-lg leading-7 font-semibold">
                <a href="/webstack/home" class="underline text-gray-900 dark:text-white">Webstack</a>
              </div>
            </div>
          ...
          <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
            <div class="flex items-center">
              ...
              <div class="ml-4 text-lg leading-7 font-semibold">
                <a href="https://learnku.com/docs/laravel/8.x"
