<head>
  ...
  <link rel="shortcut icon" href="{{ asset('webstack/favicon.ico') }}">
  <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Roboto:400,700,400italic">
  <link rel="stylesheet" href="{{ asset('webstack/css/app.css') }}">
  <script src="{{ asset('webstack/js/app.js') }}"></script>
  ...
  <meta property="og:image" content="{{ asset('webstack/img/webstack_banner_cn.png') }}">
