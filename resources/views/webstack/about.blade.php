...
<body class="page-body boxed-container">
  <nav class="navbar horizontal-menu navbar-fixed-top">
    <div class="navbar-inner">
      <div class="navbar-brand">
        <a href="/webstack" class="logo">
          <img src="{{ asset('webstack/img/logo_dark@2x.png') }}" width="100%" alt="" class="hidden-xs">
          <img src="{{ asset('webstack/img/logo@2x.png') }}" width="100%" alt="" class="visible-xs">
        </a>
      </div>
  ...
  <div class="page-container">
    ...
    <div class="main-content" style="">
      ...
      @include('webstack.layouts.footer')
    </div>
  </div>
</body>
